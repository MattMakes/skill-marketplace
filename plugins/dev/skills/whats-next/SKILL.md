---
name: whats-next
description: Create comprehensive handoff document for continuing work in a fresh context with zero information loss
---

# Context Handoff

**Output:** `./ai_docs/handoffs/whats-next.md`
...
Write to `./ai_docs/handoffs/whats-next.md` using the format below.
