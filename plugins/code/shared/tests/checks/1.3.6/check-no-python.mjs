...
//
// Usage: node plugins/code/shared/tests/checks/1.3.6/check-no-python.mjs --leaf 1.3.6
...
if (args.length !== 2 || args[0] !== "--leaf" || args[1] !== "1.3.6") {
  console.error("usage: node plugins/code/shared/tests/checks/1.3.6/check-no-python.mjs --leaf 1.3.6");
  process.exit(2);
}
