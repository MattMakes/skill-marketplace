...
//
// Usage: node plugins/code/shared/tests/checks/root/check-carried-tests.mjs
...
if (process.argv.length > 2) {
  console.error("usage: node plugins/code/shared/tests/checks/root/check-carried-tests.mjs");
  process.exit(2);
}
