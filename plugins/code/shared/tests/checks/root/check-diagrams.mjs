...
//
// Usage: node plugins/code/shared/tests/checks/root/check-diagrams.mjs <ddd-dir>
...
if (args.length !== 1 || args[0].startsWith("-")) {
  console.error("usage: node plugins/code/shared/tests/checks/root/check-diagrams.mjs <ddd-dir>");
  process.exit(2);
}
