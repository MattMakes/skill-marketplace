...
3. If implementation changes an aggregate boundary or a message contract, update the canvas / `code.json` and re-run `ddd validate ddd --step code`; upstream changes → `ddd` marks steps stale.
