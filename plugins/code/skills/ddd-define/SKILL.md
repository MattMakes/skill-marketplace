...
- **Closing summary** (a reader who sees only this message can act): absolute paths written;
  ...
  next: `/ddd-code` (or "run `ddd` to continue").
...
`ddd` to continue; review the canvases' business decisions and quality attributes first —
