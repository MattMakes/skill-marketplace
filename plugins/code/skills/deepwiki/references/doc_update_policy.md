...
```bash
python3 collect_update_context.py --include-diff --diff-context 5 --repo-path /path/to/repo --toc-file toc.json --doc-dir ./docs/wiki/
```
...
Update these two fields in place in `toc.json`; leave the rest of `project` alone.
