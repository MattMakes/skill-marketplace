...
| Path | Description |
|------|-------------|
| `{output_dir}/toc.json` | TOC definition following schema |

## Scripts

Use `${CLAUDE_PLUGIN_ROOT}/skills/deepwiki/scripts/read_files.py` to read file contents.
...
2. **Deep Dive into Code**:
   ...
   - Use `${CLAUDE_PLUGIN_ROOT}/skills/deepwiki/scripts/read_files.py` script to read these files
...
5. **Write toc.json**:
   ...
   - Generate `{output_dir}/toc.json` following the schema
