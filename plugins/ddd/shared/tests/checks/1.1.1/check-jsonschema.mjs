...
//
// Usage: node plugins/ddd/shared/tests/checks/1.1.1/check-jsonschema.mjs [--update]
...
if (args.some((a) => a !== "--update")) {
  console.error("usage: node plugins/ddd/shared/tests/checks/1.1.1/check-jsonschema.mjs [--update]");
  process.exit(2);
}
