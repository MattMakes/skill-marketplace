...
//
// Usage: node plugins/ddd/shared/tests/checks/1.1.1/check-index.mjs <ddd-dir>
...
if (args.length !== 1 || args[0].startsWith("-")) {
  console.error("usage: node plugins/ddd/shared/tests/checks/1.1.1/check-index.mjs <ddd-dir>");
  process.exit(2);
}
