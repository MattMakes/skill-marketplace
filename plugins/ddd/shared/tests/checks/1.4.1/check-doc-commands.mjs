...
//
// Usage: node plugins/ddd/shared/tests/checks/1.4.1/check-doc-commands.mjs <plugin-dir>
...
if (args.length !== 1 || args[0].startsWith("-")) {
  console.error("usage: node plugins/ddd/shared/tests/checks/1.4.1/check-doc-commands.mjs <plugin-dir>");
  process.exit(2);
}
...
for (const f of ["README.md", "shared/README.md"]) if (fs.existsSync(path.join(plugin, f))) docs.push(path.join(plugin, f));
