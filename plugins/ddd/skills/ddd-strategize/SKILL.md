...
whether aggregates get designed at all). `ddd-workflow` orchestrates the whole chain.
...
relationship) or "run `ddd-workflow` to continue". Also point at what `ddd-organise` (core team),
