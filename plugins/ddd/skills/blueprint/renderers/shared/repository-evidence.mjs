// blueprint: renamed copy of archify renderers/shared/repository-evidence.mjs (MIT, tt-a1i)
...
export function verifyRepositoryEvidence(diagramType, diagram, repoRootInput) {
  ...
  if (!repoRootInput) {
    evidenceFailure('repository-evidence/root-required', 'This diagram declares source evidence. Pass --repo-root <repository> so Blueprint can verify it before rendering.', {
      subject: { path: '/meta/repository' },
