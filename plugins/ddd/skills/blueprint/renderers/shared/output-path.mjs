// blueprint: renamed copy of archify renderers/shared/output-path.mjs (MIT, tt-a1i)
...
function probeDirectorySemantics(directory) {
  ...
  const caseAuthored = `.blueprint-Case-Probe-${suffix}`;
  const normalizationAuthored = `.blueprint-norm-\u00e9-probe-${suffix}`;
  const semantics = {
