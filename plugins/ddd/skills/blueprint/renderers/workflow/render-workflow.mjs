// blueprint: renamed copy of archify renderers/workflow/render-workflow.mjs (MIT, tt-a1i)
...
const compiled = compileWorkflow({
  workflow,
  qualityProfile: process.env.BLUEPRINT_QUALITY_PROFILE || workflow.meta?.quality_profile,
});
