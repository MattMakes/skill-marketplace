...
flows are the lineage. This is the last step of the chain (orchestrated by `ddd-workflow`); the
...
change goes through `ddd-connect` (re-run, then `ddd-workflow` marks this step stale and a
